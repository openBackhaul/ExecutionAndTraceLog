  ...
  "core-model-1-4:control-construct" : {
    "profile-collection" : {
      "profile" : [ {
        ...
        "uuid" : "eatl-0-0-1-application-p-0000",
    ...
    "forwarding-domain" : [ {
      "uuid" : "eatl-0-0-1-op-fd-0000",
      "forwarding-construct" : [ {
        "uuid" : "eatl-0-0-1-op-fc-0003",
        "name" : [ {
        ...
        "fc-port" : [ {
          ...
          "logical-termination-point" : "eatl-0-0-1-op-s-0003"
        }, {
          "local-id" : "200",
          "port-direction" : "core-model-1-4:PORT_DIRECTION_TYPE_OUTPUT",
          "logical-termination-point" : "eatl-0-0-1-op-c-0050"
        } ]
      }, {
        "uuid" : "eatl-0-0-1-op-fc-0004",
        "name" : [ {
          "value-name" : "ForwardingKind",
          "value" : "core-model-1-4:FORWARDING_KIND_TYPE_INVARIANT_PROCESS_SNIPPET"
        }, {
        ...
        "fc-port" : [ {
          "local-id" : "000",
          "port-direction" : "core-model-1-4:PORT_DIRECTION_TYPE_MANAGEMENT",
          "logical-termination-point" : "eatl-0-0-1-op-s-0005"
        }, {
          "local-id" : "200",
          "port-direction" : "core-model-1-4:PORT_DIRECTION_TYPE_OUTPUT",
          "logical-termination-point" : "eatl-0-0-1-op-c-0060"
        } ]
      } ]
    } ],
    "logical-termination-point" : [ {
      "uuid" : "eatl-0-0-1-op-c-0020",
      "ltp-direction" : "core-model-1-4:TERMINATION_DIRECTION_SINK",
      "client-ltp" : [ ],
      "server-ltp" : [ "eatl-0-0-1-http-c-0020" ],
      "layer-protocol" : [ {
        "local-id" : "0",
      ...
      "uuid" : "eatl-0-0-1-http-c-0020",
      "ltp-direction" : "core-model-1-4:TERMINATION_DIRECTION_SINK",
      "client-ltp" : [ "eatl-0-0-1-op-c-0020" ],
      "server-ltp" : [ "eatl-0-0-1-tcp-c-0020" ],
      "layer-protocol" : [ {
        "local-id" : "0",
